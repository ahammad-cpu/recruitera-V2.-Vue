...
<template>
  <div v-if="job">
    ...
    <!-- Content card overlapping the cover (less overlap on mobile so the
         short banner still shows) -->
    <div class="relative z-10 mx-auto max-w-[1160px] px-6 -mt-4 sm:-mt-10 md:-mt-16 pb-16">
